...
const Banner = ( { color, image, title, info, subtitle, especialidad, home, poster, courseBanner  } ) => ( 
  // l-block para separar abajo unos espacios
        ...
        />
        {
          ...
          <div className="ed-grid m-grid-2">
            <div className="main-banner__data">
              ...
              <p>{ `${ subtitle }` }</p>
              <Link to='/cursos' className='button third-color'>Ver cursos</Link>
            </div>
